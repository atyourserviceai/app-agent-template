/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 85cdb4b6692ee1a78bab1dd985db9d6f)
...
declare namespace Cloudflare {
	interface Env {
		...
		APP_AGENT_TEMPLATE_SECRET: "app-agent-template-secret-dev" | "app-agent-template-secret-staging" | "app-agent-template-secret-production";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SETTINGS_ENVIRONMENT" | "APP_AGENT_TEMPLATE_SECRET" | "GATEWAY_API_KEY" | "GATEWAY_BASE_URL" | "OAUTH_PROVIDER_BASE_URL" | "BROWSERBASE_API_KEY" | "COMPOSIO_API_KEY">> {}
}
