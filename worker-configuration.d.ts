/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9aa3b5e5039b2383b7c6ad8f8e96a661)
...
declare namespace Cloudflare {
	interface Env {
		...
		OAUTH_CLIENT_SECRET: "app-agent-template-secret-dev" | "app-agent-template-secret-staging" | "app-agent-template-secret-production";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SETTINGS_ENVIRONMENT" | "OAUTH_CLIENT_SECRET" | "GATEWAY_API_KEY" | "GATEWAY_BASE_URL" | "OAUTH_PROVIDER_BASE_URL" | "BROWSERBASE_API_KEY" | "COMPOSIO_API_KEY">> {}
}
