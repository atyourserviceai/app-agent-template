/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a4d964875903bada695f1411e12cf7f4)
...
declare namespace Cloudflare {
	interface Env {
		...
		ATYOURSERVICE_OAUTH_CLIENT_ID: "app-agent-template" | "app-agent-template--staging";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GATEWAY_BASE_URL" | "OAUTH_PROVIDER_BASE_URL" | "SETTINGS_ENVIRONMENT" | "ATYOURSERVICE_OAUTH_CLIENT_ID" | "ATYOURSERVICE_OAUTH_REDIRECT_URI" | "ATYOURSERVICE_OAUTH_CLIENT_SECRET" | "BROWSERBASE_API_KEY" | "COMPOSIO_API_KEY">> {}
}
